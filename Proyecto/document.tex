...
Para mitigar fuga de información se evitaron atributos derivados de la fecha de entrega, se mantuvo el orden temporal en la partición y se empleó validación con \textit{TimeSeriesSplit}. Aun así, el modelo asume que las condiciones logísticas permanecen estables (stock, rutas, clima), lo que representa una posible fuente de error si esos factores cambian.
