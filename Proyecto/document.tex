...
La variable objetivo presenta una mediana de 10.2 días y una media de 12.5, con cola larga de valores atípicos por encima de 30 días. La distancia geográfica mostró la mayor correlación con el tiempo de entrega (0.394). Los estados remotos del norte (RR, AP, AM) registraron promedios de 26--29 días, mientras que São Paulo entregó en 8.8 días; la brecha supera 3 veces entre regiones. Como vendedores, AM llegó a 47.8 días de media, evidenciando el impacto logístico al despachar desde la Amazonia. Las variables temporales tuvieron efecto marginal: comprar en fin de semana o fuera de horario laboral añadió menos de 0.5 días.
